...
public class BulletA extends BulletUniversal {
	
	public BulletA(double x,double y,double dx, double dy,Color color,int life,double size,double speed){
		this.x=x;
		this.y=y;
		this.dx=dx;
		this.dy=dy;
	...
	public static BulletA createBullet(double tx, double ty){
