...
public class BulletB {
	public int width,height,speed, attack;
	public double x,y,dx,dy;
	private Color color;
	public static final int fireOffset=400;
	public static ParticleRect[] particles;
	BulletB(double x, double y,double dx,double dy){
		this.x=x;
		this.y=y;
		this.attack=Main.player.attack+50;
		this.speed=30;
